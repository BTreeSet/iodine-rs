...
mod tests {
    ...
    const QUERY_PACKET: &[u8] = b"\x05\x39\x01\x00\x00\x01\x00\x00\x00\x00\x00\x01\x2D\x41\x6A\x62\x63\
...
\x79\x6F\x02\x73\x65\x00\x00\x0A\x00\x01\x00\x00\x29\x10\x00\x00\x00\x80\x00\x00\x00";
    ...
    const ANSWER_PACKET: &[u8] = b"\x05\x39\x84\x00\x00\x01\x00\x01\x00\x00\x00\x00\x05\x73\x69\x6C\x6C\
...
\x74\x6F\x20\x62\x65\x20\x64\x65\x6C\x69\x76\x65\x72\x65\x64";
    ...
    const ANSWER_PACKET_HIGH_TRANS_ID: &[u8] = b"\x85\x39\x84\x00\x00\x01\x00\x01\x00\x00\x00\x00\x05\x73\x69\x6C\
...
\x20\x74\x6F\x20\x62\x65\x20\x64\x65\x6C\x69\x76\x65\x72\x65\x64";
    ...
    fn parse_packet_with_a_answer_and_pointer_name() {
        ...
        assert_eq!(parsed.answers[0].rdata, DnsRdata::A([0x5D, 0xB8, 0xD8, 0x22]));
    }
